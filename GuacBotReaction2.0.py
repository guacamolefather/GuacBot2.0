...
async def on_message(message):
    ...
    if "alone" in message.content.lower() or "lonely" in message.content.lower():
        await message.channel.send("It’s dangerous to go alone, take this! https://tenor.com/view/hugs-sending-virtual-hugs-loading-gif-8158818")
    #17
